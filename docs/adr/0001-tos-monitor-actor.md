...
Nexstar Media Group, Inc., per ADR-2607110300 -- a read-only reference
...
- **Company**: Nexstar Media Group, Inc., LEI 52990083ZRR5UT591988, website
  `https://www.nexstar.tv`.
- **Baseline provenance** (real, from this repo's own `80-data/public/
  tos.journal.edn`): source-url `https://www.nexstar.tv/terms-of-use/`,
...
proves the actor pattern holds for yet another, independently different
