(ns tosmonitor.store
  ...
  This repo archives exactly ONE company (Nexstar Media Group, Inc., LEI
  52990083ZRR5UT591988) -- unlike `commitledger.store`'s multi-application
...
(defn demo-company []
  {:legal-name "Nexstar Media Group, Inc."
   :website    "https://www.nexstar.tv"})

(def ^:private demo-full-text
  "Terms of Use\nBy accessing or using this website, mobile application, or connected TV application you agree to these Terms of Use. Content made available on these properties is provided by Nexstar Media Group, Inc. and its affiliated broadcasting stations for informational purposes only and is subject to change without notice. These Terms are governed by the laws of the State of Delaware.")

(defn demo-baseline []
  {:full-text    demo-full-text
   :source-url   "https://www.nexstar.tv/terms-of-use/"
